...
# 3. publish
git add docs/apt && git commit -m "release 0.2.1" && git push   # GitHub Pages serves the repo
...
./packaging/build-ppa.sh 0.2.1 noble            # → dist/ppa/ (noble+ : libadwaita 1.4 requis)
